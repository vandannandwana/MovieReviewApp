...
* **Request Body**:  
  ...
  * **Note**: movie\_id is expected to be provided in the request body. In a real-world scenario, this might come from an external movie API (like TMDB) or be generated by your application logic.  
...
* **Request Body**:  
  {  
      "review\_id": 2001, // For demo, usually generated by DB  
      "movie\_id": 1001,  
      "user\_id": 1,      // This is the 'user\_id' (int64) from the users table  
      "title": "Amazing Movie\!",  
  ...
  * **Important**: The user\_id here must be the integer ID of an existing user, not their email.  
